...
const resentOtpController = (dependencies) => {
    ...
    return async (req, res, next) => {
        try {
            ...
            userCreated_1.default.produceAll({ payload: response }, (0, userCreated_1.UserBatchMessages)(response));
...
exports.resentOtpController = resentOtpController;
