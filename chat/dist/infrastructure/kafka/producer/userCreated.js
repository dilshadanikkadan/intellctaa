...
exports.paymentSuccessBatch = exports.ForgotPasswordBatch = exports.InstructorCreateBatch = exports.UserBlockBatch = exports.UserBatchMessages = void 0;
...
const paymentSuccessBatch = (data) => {
    return [
        {
            topic: common_1.Subjects.CourseService,
            messages: [
                {
                    key: common_1.PaymentTopics.PaymentSuccess,
                    value: JSON.stringify(data),
                },
            ],
        },
...
exports.paymentSuccessBatch = paymentSuccessBatch;
